...
<?php
// - Per poter usare la struttura dati precedentemente acquisita (in json) devo usare una funzione che mi decodifica la struttura dati, in modo da poterla leggere in PHP.
